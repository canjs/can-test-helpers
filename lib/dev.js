/**
 * @module {Object} can-test/dev dev
 * @parent can-test
 *
...
module.exports = {
	/**
	 * @function can-test/lib/dev.willWarn willWarn
	 * @parent can-test/dev
	 ...
	 * ```
	 * var dev = require('can-util/js/dev/dev');
	 * var devTest = require('can-test/lib/dev');
	 * 
	 * var finishWarningCheck = devTest.willWarn("something evil", function(message, match) {
	...
	/**
	 * @function can-test/lib/dev.willError willError
	 * @parent can-test/dev
	 ...
	 * var devTest = require('can-test/lib/dev');
	 * 
	 * var finishErrorCheck = devTest.willError("something evil", function(message, match) {
	 * 	 message; // -> "something evil"
	 * 	 match; // true
	 * });
	 *
	...
	/**
	 * @function can-test/lib/dev.devOnlyTest devOnlyTest
	 * @parent can-test/dev
